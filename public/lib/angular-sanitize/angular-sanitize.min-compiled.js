...
(function (A, e, B) {
  ...
  function C(a) {
    ...
    var b = {},
        d = a.split(","),
        l;for (l = 0; l < d.length; l++) b[c ? e.lowercase(d[l]) : d[l]] = !0;return b;
  }function D(a, c) {
    ...
    var b = !1,
        d = e.bind(a, a.push);return { start: function (a, f) {
    ...
    var c = /((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i,
      ...
      function k(a) {
        ...
        var c;p.push("<a ");e.isFunction(m) && (m = m(a));if (e.isObject(m)) for (c in m) p.push(c + '="' + m[c] + '" ');else m = {};!e.isDefined(h) || "target" in m || p.push('target="', h, '" ');p.push('href="', a.replace(/"/g, "&quot;"), '">');k(b);p.push("</a>");
...
//# sourceMappingURL=angular-sanitize.min-compiled.js.map