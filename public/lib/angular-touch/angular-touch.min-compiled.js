...
(function (x, n, y) {
  ...
  function s(f, k) {
      ...
      return function (l, u, g) {
        function h(c) {
          if (!d) return !1;var a = Math.abs(c.y - d.y);c = (c.x - d.x) * k;return r && 75 > a && 0 < c && 30 < c && .3 > a / c;
            ...
            d,
            r,
            c = ["touch"];n.isDefined(g.ngSwipeDisableMouse) || c.push("mouse");b.bind(u, { start: function (c, a) {
            d = c;r = !0;
          }, cancel: function (c) {
            r = !1;
          }, end: function (c, d) {
    ...
    }var e = { mouse: { start: "mousedown", move: "mousemove", end: "mouseup" }, touch: { start: "touchstart", move: "touchmove", end: "touchend", cancel: "touchcancel" } };return { bind: function (a, b, l) {
        var e,
            g,
            h,
            m,
    ...
    function a(a, d, b) {
      ...
      a = a.touches && a.touches.length ? a.touches : [a];var b = a[0].clientX,
        ...
        for (var a = 0; a < g.length; a += 2) if (g[a] == b && g[a + 1] == e) {
...
//# sourceMappingURL=angular-touch.min-compiled.js.map